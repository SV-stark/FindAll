...
fn bench_search(c: &mut Criterion) {
    ...
    group.bench_function("search_common_word", |b| b.iter(|| perform_search(&indexer, "content")));
    group.bench_function("search_rare_word", |b| b.iter(|| perform_search(&indexer, "needle 500")));
    group.bench_function("search_fuzzy", |b| b.iter(|| perform_search(&indexer, "benxmarking")));
    group.finish();
}
